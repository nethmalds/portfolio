...
import { CertificationCard, CertificationType } from "@/components/certification-card";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {loading ? (
            Array.from({ length: 4 }).map((_, index) => (
              <div key={`skeleton-${index}`} className="animate-pulse h-full border rounded-lg bg-background p-4 flex flex-col justify-between">
                <div className="pb-3">
